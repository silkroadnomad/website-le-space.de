<script>
    ...
    let timeline_en = [
        ...
        { image: CoworkingGoaSunsetMediation01 , year:"2013-2016", headline: "Remote.Yoga Startup / Akashionata", industry:"Health", location: "Agonda, Goa, Republic Indien", projects:"video & audio educational platform for yoga students and yoga teacher (mobile & web)", technologies: "MeteorJS, WebRTC, Apache-Cordoba, React-Native, Android, iOS", icons:[{icon:"webrtc", url: "https://webrtc.org/"},{icon:"android.png", url:"https://www.android.com/"},{icon:"ios.png", url:"https://www.apple.com/de/ios"},{icon:"meteor", url: "https://www.meteor.com/"},{icon:"javascript", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript"},{icon:"apachecordova", url: "https://cordova.apache.org/"},{icon:"intellijidea", url: "https://www.jetbrains.com/idea/"}]},
        ...
        { image: CoworkingLeipzig01, year: "2009", headline: "Launching Le Space (beta) Coworking zu Leipzig", industry:"real estate / marketing / networking / education", location: "Leipzig, Germany", projects: 'Launching a Coworking Space, Co-Organizing Coworking Week Germany (2010), Joining 1st Coworking Europe Conference (2010)', technologies: 'Coworking, Bar Camps, Events', icons:[{icon:"mdr.png",url:"https://www.mdr.de/tv/"},{icon:"mdr-info",url:"https://www.mdr.de/mdr-aktuell-nachrichtenradio"},{icon:"kreuzer-leipzig.jpg",url:"https://kreuzer-leipzig.de/"},{icon:"lvz.jpg",url:"https://www.lvz.de"},{icon:"dnn.jpg",url:"https://www.dnn.de/"}]},
    ...
    const timeline_de = [
        ...
        { image: CoworkingGoaSunsetMediation01 , year:"2013-2016", headline: "Remote.Yoga Startup / Akashionata", industry:"Health", location: "Agonda, Goa, Republik Indien", projects:"Video/Audio Bildungsplatform für Yogalehrer und Yogaschüler (Mobile & Web)", technologies: "MeteorJS, WebRTC, Apache-Cordoba, React-Native, Android, iOS", icons:[{icon:"webrtc", url: "https://webrtc.org/"},{icon:"android.png", url:"https://www.android.com/"},{icon:"ios.png", url:"https://www.apple.com/de/ios"},{icon:"meteor", url: "https://www.meteor.com/"},{icon:"javascript", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript"},{icon:"apachecordova", url: "https://cordova.apache.org/"},{icon:"intellijidea", url: "https://www.jetbrains.com/idea/"}]},
