<script>
     ...
     */
    const timeline = [
        { image: LabWeek2023LibP2P01, year: "2023", headline: "Local First Software & Peer-To-Peer", industry:"Blockchain / Peer-To-Peer", location: "Istanbul, Republic of Türkiye", projects: 'Attending Labweek23 Conference, LibP2P day, IPFSConnect', technologies: 'P2PLib, IPFS, Helia', icons:[{icon:"libp2p", url: "https://libp2p.io/"}, {icon:"helia.png", url: "https://helia.io/"}, {icon:"ipfs", url: "https://ipfs.io/"}, {icon:"svelte", url: "https://svelte.dev/"},{icon:"typescript", url: "https://www.typescriptlang.org/"}]},
        ...
        { image: BitcoinCore01, year: "2011", headline: "Bitcoin Principles / Groovy & Grails", industry:"Crypto Currencies, Blockchain, IT administration", location: "Rishikesh, Republic of India", projects: 'Bitcoin evaluation, Implementing a activity report web app', technologies: 'The Bitcoin Principles, Bitcoin Core, Groovy & Grails, SQL, MongoDB',icons:[{icon:"bitcoin", url: "https://bitcoin.org/"}, {icon:"grails", url: "https://grails.org/"}, {icon:"apachegroovy", url: "https://groovy-lang.org/"},{icon:"mongodb", url: "https://www.mongodb.com/"},{icon:"selenium", url:"https://www.selenium.dev/"} ]},
        { image: KarakorumWorking01, year: "2011", headline: "travelling along the silk road", industry:"Sabbatical Industry",  location: "Islamic Republic of Pakistan", projects: 'Studies of world history, Gaining Cultural Competence', technologies: 'humility & openness' ,icons: [{ icon: "nusrat-fateh-ali-khan.jpg", url: "https://youtu.be/d7AqPH-LgmI"}]},
